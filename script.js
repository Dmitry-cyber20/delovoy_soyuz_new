function Sim(sldrId) {
    ...
    if (id) {
      ...
      this.sldrRoot = document.querySelector(".sim-slider", ".sim-slider_2");
    }
  ...
  // карусель строительство
  let carouselContainer = document.querySelector('.carousel-construction-container');
